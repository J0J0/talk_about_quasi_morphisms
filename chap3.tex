...
\begin{thProposition}[Unterraum von $\Hb^2(G;\R)$ via $V_0(G)$]
...
\begin{thBeispiel}%
    ...
    \txtZQuot3$ (für die Isomorphie siehe beispielsweise
    Alperin\cite{alperin93}). Um zu zeigen, dass
    $\Hb^2( \operatorname{PSL}_2(\Z); \R )$
