...
\begin{thBeispiel}%
    ...
    \[ V_0\bigl(\operatorname{PSL}_2(\Z)\bigr)
        \cong \hatCb^1(\txtZQuot2) \times \hatCb^1(\txtZQuot3)
    \]
    ...
    eindeutig bestimmt. Für $\txtZQuot2$ gilt also $\hatCb^1(\txtZQuot2) =
    \{0\}$. Aber für $\txtZQuot3$ können wir den Wert auf der Restklasse von~$1$
    frei vorgeben, so dass wir 
    \[ \hatCb^1(\txtZQuot3) \cong \R \qtextq{und damit}
